...
email = st.text_input("E-mailová adresa", placeholder="jmeno@domena.cz")
...
send_btn = st.button(
    "Odeslat na webhook",
    type="primary",
    disabled=(json_data is None or not email)
)

if send_btn and json_data is not None and email:
    payload = {
        "email": email,
        "data": json_data,
    }
